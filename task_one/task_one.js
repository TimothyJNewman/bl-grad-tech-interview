...
console.log(getNumOfChanges("yP717")); // Expect: 2
...
console.log(getNumOfChanges("superc889")); // Expect: 1
...
console.log(getNumOfChanges("superrrrrrcalifff")); // Expect: 5
...
console.log(getNumOfChanges("1111111111111111111")); // Expect: 17